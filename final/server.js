...
matrixGenerator(50, 20, 2, 2, 2, 2, 2);
//! Creating MATRIX -- END
...
function game() {
    ...
    seasontime++;
    if (seasontime >= 0 && seasontime <= 5) {
        season = "winter";
    }
    else if (seasontime >= 6 && seasontime <= 11) {
        season = "spring";
    }
    else if (seasontime >= 12 && seasontime <= 17) {
        season = "summer";
    }
    else if (seasontime >= 18 && seasontime <= 23) {
        season = "autumn";
    }
    else {
        seasontime = 0;
